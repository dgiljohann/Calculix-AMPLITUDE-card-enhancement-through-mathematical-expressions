...
2) Add the 2 new C files equamplitude.c and the latest version of tinyexpr.c from  https://github.com/codeplea/tinyexpr to your makefile.
...
* Do not use equation string amplitudes together with the SHIFTX or SHIFTY option as provided by ccx. In such cases an error will be displayed on the console. If you need such a shift it is recommended to make the shift(s) part of your equation definition!
