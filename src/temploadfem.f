...
!     
     ...
     &     veold(0:mi(2),*),ddummy,doubleglob(*),prop(*),
...
!     
      do i=1,nam
        ...
        if(amequ(i).eq.'') then
!         User defined amplitude in uamplitude.f:
...
!         Equation string defined amplitude in equamplitude.c:
          call equamplitude(reftime, amname(abs(namta(3,i))),
     &           amequ(i), ampli(i))
        endif
      enddo
!     
