...
!     
     ...
     &     matname,ielmat,orname,orab,ielorien,amname,amequ,
     &     amta,namta,nam,
...
!     
      if(textpart(1)(1:10).eq.'*AMPLITUDE') then
        call amplitudes(inpc,textpart,amname,amequ,amta,namta,nam,
...
!     
     ...
     &       iamboun,amname,
     &       amequ,nam,ipompc,nodempc,coefmpc,nmpc,nmpc_,
...
!     
     ...
     &       ialset,nset,nodeboun,ndirboun,xboun,nboun,nboun_,nk,
     &       iamboun,amname,amequ,
     &       nam,ipompc,nodempc,coefmpc,nmpc,nmpc_,
...
!     
     ...
     &       amname,amequ,
     &       nam,ntrans,trab,inotr,co,ikforc,ilforc,nk,
...
!     
     ...
     &       iamforc,amname,amequ,
     &       nam,ntrans,trab,inotr,co,ikforc,ilforc,
...
!     
     ...
     &       ielmat,ntmat_,iamload,amname,amequ,
     &       nam,lakon,ne,dflux_flag,
...
!     
     ...
     &       ialset,nset,nelemload,sideload,xload,nload,nload_,
     &       ielmat,iamload,amname,amequ,
     &       nam,lakon,ne,dload_flag,istep,istat,n,
...
!     
     ...
     &       amname,amequ,amta,namta,t0,t1,iamt1,veold,ielmat,
...
!     
     ...
     &       ipoinpc,network,iamplitudedefault,amname,amequ,nam,
...
!     
     ...
     &       ialset,nset,t0,t1,nk,ithermal,iamt1,amname,amequ,nam,
...
!     
      elseif(textpart(1)(1:11).eq.'*TIMEPOINTS') then
        call timepointss(inpc,textpart,amname,amequ,amta,namta,nam,
     &       nam_,namtot_,irstrt,istep,istat,n,iline,ipol,inl,ipoinp,
     &       inp,ipoinpc,namtot,ier)
!     
